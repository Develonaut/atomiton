...
export class CreatePage extends BasePage {
  ...
  constructor(page: Page) {
    super(page);
    this.createContainer = page.locator('[data-testid="create-container"], .create-page, main').first();
    this.canvas = page.locator('canvas').first();
    this.toolsPanel = page.locator('[data-testid="tools"], .tools, .sidebar').first();
    this.saveButton = page.locator('[data-testid="save"], button:has-text("Save")').first();
    this.previewButton = page.locator('[data-testid="preview"], button:has-text("Preview")').first();
  }
