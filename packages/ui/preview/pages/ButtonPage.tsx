...
export function ButtonPage() {
  return (
    <Container size="xl" py="md">
      <Stack gap="lg">
        <div>
          <Title order={2} mb="sm">Buttons</Title>
          <Text c="dimmed">
        ...
        {/* Primary Buttons */}
        <div>
          <Title order={3} mb="md">Primary Buttons</Title>
          <SimpleGrid cols={4} spacing="md" verticalSpacing="sm">
            <Stack gap="sm" align="center">
              <Button variant="primary">Primary</Button>
              <Text size="xs" c="dimmed" ta="center">Default</Text>
            </Stack>

            <Stack gap="sm" align="center">
              <Button variant="primary" disabled>Primary</Button>
              <Text size="xs" c="dimmed" ta="center">Disabled</Text>
            </Stack>
            ...
            <Stack gap="sm" align="center">
              ...
              <Text size="xs" c="dimmed" ta="center">Large size</Text>
            </Stack>
          </SimpleGrid>
        </div>
        ...
        {/* Secondary Buttons */}
        <div>
          <Title order={3} mb="md">Secondary Buttons</Title>
          <SimpleGrid cols={4} spacing="md" verticalSpacing="sm">
            <Stack gap="sm" align="center">
        ...
        {/* Danger Buttons */}
        <div>
          <Title order={3} mb="md">Danger Buttons</Title>
          <SimpleGrid cols={4} spacing="md" verticalSpacing="sm">
            <Stack gap="sm" align="center">
        ...
        {/* Default Buttons */}
        <div>
          <Title order={3} mb="md">Default Buttons</Title>
          <SimpleGrid cols={4} spacing="md" verticalSpacing="sm">
            <Stack gap="sm" align="center">
        ...
        <div>
          ...
          <SimpleGrid cols={3} spacing="md" verticalSpacing="sm">
            <Stack gap="sm" align="center">
              ...
              <Text size="xs" c="dimmed" ta="center">Small</Text>
            </Stack>

            <Stack gap="sm" align="center">
              <Button variant="primary" size="md">Medium</Button>
              <Text size="xs" c="dimmed" ta="center">Medium (default)</Text>
            </Stack>

            <Stack gap="sm" align="center">
              <Button variant="primary" size="lg">Large</Button>
              <Text size="xs" c="dimmed" ta="center">Large</Text>
            </Stack>
          </SimpleGrid>
        </div>
        ...
        {/* Full Width */}
        <div>
          <Title order={3} mb="md">Full Width</Title>
          <Stack gap="md">
