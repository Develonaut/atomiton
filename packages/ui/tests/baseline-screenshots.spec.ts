...
test.describe('Baseline Screenshots - Full Page Capture', () => {
  ...
  for (const page of pages) {
    test(`Capture ${page.name} page - Full Page`, async ({ page: browserPage }) => {
      ...
      console.log(`✅ Captured full page screenshot for ${page.name} (${dimensions.width}x${dimensions.height}px)`);
