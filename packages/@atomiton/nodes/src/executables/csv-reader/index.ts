 ...
 * CSV Reader node executable
 */
export const csvReaderExecutable: NodeExecutable<CSVReaderParameters> = createNodeExecutable({
  async execute(
    ...
    try {
      ...
      const records = parseCSV(
        csvContent,
        params.delimiter as string,
        params.hasHeaders as boolean,
        params.skipEmpty as boolean,
      );
